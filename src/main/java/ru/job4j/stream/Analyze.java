...
public class Analyze {
    ...
    public static List<Tuple> averageScoreBySubject(Stream<Pupil> stream) {
        LinkedHashMap<String, Double> collect = stream.flatMap(pupil -> pupil.subjects().stream())
    ...
    public static Tuple bestStudent(Stream<Pupil> stream) {
        return stream.map(pupil -> new Tuple(pupil.name(), pupil.subjects().stream().mapToInt(Subject::score).sum()))
